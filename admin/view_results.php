...
if ($filter_reg) {
    ...
    $res = $conn->query("SELECT * FROM results WHERE registration_no='$fr' ORDER BY subject_code");
          ...
          <div class="card" style="margin-bottom:16px;">
            ...
            <div class="card-body">
              ...
              <div class="table-wrap">
                <table>
                  <thead>
                    <tr><th>Subject Code</th><th>CA (60)</th><th>SE (40)</th><th>Total (100)</th><th>Grade</th><th>Progress</th></tr>
                  </thead>
                  <tbody>
