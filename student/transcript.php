...
// Fetch results
$res = $conn->prepare("SELECT * FROM results WHERE registration_no=? ORDER BY subject_code");
  ...
  <div class="page-inner">
    ...
    <div class="letterhead">
      <div>
        ...
        <div class="lh-name">Don Bosco - KIITEC</div>
      </div>
      <div class="lh-right">
    ...
    <div class="declaration">
      ...
      <strong><?= htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) ?></strong>
      (<?= htmlspecialchars($user['registration_no']) ?>) as recorded in the official academic registry of Don Bosco - KIITEC.
    ...
    <div class="doc-footer">
      <div>
        ...
        <div>Generated <?= $gen_date ?> at <?= $gen_time ?> &bull; Don Bosco - KIITEC Academic Records System</div>
