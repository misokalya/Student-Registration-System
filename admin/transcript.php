...
/* Progress bar */
.bwrap { width: 66px; height: 6px; background: #e2e6f0; border-radius: 99px; overflow: hidden; display: inline-block; vertical-align: middle; }
.bfill { height: 100%; border-radius: 99px; background: linear-gradient(90deg, #ffbf00, #ff7900); }
...
<div class="page-wrap">
  ...
  <div class="page-inner">
    ...
    <div class="letterhead">
      <div>
        <div class="lh-name">College Portal</div>
        <div class="lh-sub">Student Registration &amp; Academic Records</div>
      </div>
      <div class="lh-right">
        <div class="lh-doc">Academic Transcript</div>
        <div class="lh-date">Official Document &mdash; <?= $gen_date ?></div>
      </div>
    </div>
    ...
    <div class="summary-row">
      <div class="sum-box">
        <div class="sum-accent" style="background:#ffbf00;"></div>
        <div class="sum-body">
          <div class="sum-val"><?= $subject_count ?></div>
          <div class="sum-lbl">Subjects Taken</div>
        </div>
      </div>
      <div class="sum-box">
        <div class="sum-accent" style="background:#ff7900;"></div>
        <div class="sum-body">
          <div class="sum-val"><?= $avg_score ?>%</div>
          <div class="sum-lbl">Average Score</div>
        </div>
      </div>
      <div class="sum-box">
        <div class="sum-accent" style="background:#ffe642;"></div>
        <div class="sum-body">
          <div class="sum-val"><?= $gpa ?><span style="font-size:0.72rem;font-weight:400;color:#94a3b8;"> / 4.0</span></div>
          <div class="sum-lbl">GPA</div>
        </div>
      </div>
      <div class="sum-box">
        <div class="sum-accent" style="background:<?= $remark_color ?>;"></div>
        <div class="sum-body">
          <div class="sum-val" style="color:<?= $remark_color ?>;"><?= $remark ?></div>
          <div class="sum-lbl">Overall Remark</div>
        </div>
      </div>
    </div>
    ...
    <table class="rt">
      <thead>
        <tr>
          ...
          <th class="al">Subject Code</th>
          <th class="al">Subject Name</th>
          <th>CA <span style="font-weight:400;opacity:0.6;">(60)</span></th>
          <th>SE <span style="font-weight:400;opacity:0.6;">(40)</span></th>
          <th>Total <span style="font-weight:400;opacity:0.6;">(100)</span></th>
          <th>Grade</th>
          <th>Progress</th>
          <th>Remarks</th>
        </tr>
      ...
      ?>
        <tr>
          ...
          <td class="al" style="font-size:0.78rem;color:#4a5568;"><?= $r['resolved_name'] !== '' ? htmlspecialchars($r['resolved_name']) : '<span style="color:#b0b8cc;">—</span>' ?></td>
          ...
          <td><div class="bwrap"><div class="bfill" style="width:<?= $pct ?>%;"></div></div></td>
      ...
      <tfoot>
        <tr>
          <td class="al" colspan="4" style="font-size:0.7rem;color:#94a3b8;font-weight:600;letter-spacing:.04em;">OVERALL AVERAGE</td>
          <td style="color:#ff7900;"><?= $avg_score ?>%</td>
          <td style="color:<?= $remark_color ?>;"><?= $remark ?></td>
          <td colspan="2"></td>
        </tr>
      </tfoot>
    </table>
    ...
    <div class="declaration">
      ...
      <strong><?= htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) ?></strong>
      (<?= htmlspecialchars($user['registration_no']) ?>) as recorded in the official academic registry of College Portal.
    ...
    <div class="doc-footer">
      <div>
        ...
        <div>Generated <?= $gen_date ?> at <?= $gen_time ?> &bull; College Portal Academic Records System</div>
