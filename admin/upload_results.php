...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_import'])) {
    ...
    foreach ($rows as $row) {
        ...
        $stmt = $conn->prepare("INSERT INTO results (registration_no, subject_code, ca_score, se_score, total_score, grade, upload_batch)
            VALUES (?,?,?,?,?,?,?)
            ON DUPLICATE KEY UPDATE ca_score=VALUES(ca_score), se_score=VALUES(se_score),
            total_score=VALUES(total_score), grade=VALUES(grade)");
        $stmt->bind_param("ssdddsi", $reg, $code, $ca, $se, $total, $grade, $batch_id);
  ...
  <div class="main">
    ...
    <div class="page-content">
      <div class="page-header">
        ...
        <p>Import student results from a CSV file. Required columns: <code>registration_no, subject_code, CA, SE, Total, Grade</code></p>
      </div>
      ...
      <div class="card" style="margin-bottom:24px;">
        ...
        <div class="card-body">
          ...
          <p style="margin-top:10px;font-size:0.78rem;color:var(--muted);">Optional columns <code>first_name</code> and <code>last_name</code> are ignored — student data is matched by <code>registration_no</code>.</p>
        </div>
      </div>
      ...
      <form method="POST">
        ...
        <div class="card" style="margin-bottom:16px;">
          ...
          <div class="card-body" style="padding:0;">
            <div class="table-wrap">
              <table>
                <thead><tr><th>Subject Code</th><th>CA</th><th>SE</th><th>Total</th><th>Grade</th></tr></thead>
                <tbody>
